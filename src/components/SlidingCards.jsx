    ...
    <div className="mx-auto" style={{ maxWidth: '600px' }}>
        <p className="text-lg text-justify">
            ...
            <div className=''>
                <Slider {...settings}>
                    {data.map((d, index) => (
                        <div key={index} className='group mt-10 bg-white h-[340px] flex flex-col text-primary  rounded-xl transition-colors duration-300 hover:bg-gray-100'>
                            {/* Card container */}
                            <div className='relative h-56 rounded-t-xl flex flex-col justify-center items-center'>
                                ...
                                />
                                <div className='flex text-xl font-bold flex-col justify-center items-center gap-4 p-4 transform transition-transform duration-300 ease-in-out group-hover:scale-0' style={{ color: '#4e6185' }}>
