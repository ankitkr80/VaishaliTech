...
const OnlinePresence = () => {
  return (
    <div className="flex flex-col ml-4 mt-6 p-6 bg-white shadow-lg rounded-lg sm:ml-10 sm:mt-5 md:flex-row md:items-center md:ml-10 lg:ml-20 xl:ml-32"> {/* Adjusted margins for responsiveness */}
      <div className="w-full md:w-1/2 space-y-4"> {/* Full width on small screens, half width on medium screens and above */}
        ...
        <p className="text-gray-600 text-base sm:text-lg"   style={{ textAlign: "justify" }}> {/* Smaller text for mobile, larger for small screens and above */}
        ...
        <button className="w-full sm:w-auto bg-blue-700 text-white py-2 px-4 rounded hover:bg-blue-800 transition" style={{ background: 'var(--secondary-color)' }}>
          Schedule a Call
        </button>
      </div>
      <div className="w-full mt-6 flex justify-center md:w-1/2 md:mt-0"> {/* Full width on mobile, adjust margin for spacing */}
        <img
